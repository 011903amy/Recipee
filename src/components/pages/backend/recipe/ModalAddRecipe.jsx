                ...
                <Form>
                  <div className="grid grid-cols-[1fr,_1.5fr,_1.5fr] gap-5">
                    ...
                    />
                      ...
                      <div className="input-wrap">
                        <InputSelect label="Category" name="recipe_category_id"  onChange={handleChange}>
                      ...
                      <div className="input-wrap">
                        <InputSelect label="Level" name="recipe_level_id"  onChange={handleChange}>
                        <option value="hidden"></option>
                        {level?.data.map((item, key) => {
                          return(
                            <>
                            {item.level_is_active === 1 && (
                              <option value={item.level_aid} key={key}>{item.level_title}</option>
                            )}
                            </>
                          )
                        })}
