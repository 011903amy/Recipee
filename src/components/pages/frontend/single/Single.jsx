  ...
  return (
    ...
    <section className='bg-dark text-white'>
      <div className="container">
        <div className='py-25'>
        <img src={`${imgPath}/${getSingleRecipe() !== undefined && getSingleRecipe()[0].recipe_image}`} alt="" className='h-[500px] w-full object-cover'  />
        ...
        <li className='flex gap-2 items-center'><HandPlatter/>{getSingleRecipe() !== undefined && getSingleRecipe()[0].recipe_category}</li>
          ...
          <div className="grid grid-cols-[1.5fr,_3fr] gap-10 max-w-[900px] mx-auto mt-10 text-left">
            ...
            <div className='wrapper-instruction'>
              <h3>Instruction</h3>
              <Markdown>
              {getSingleRecipe() !== undefined && getSingleRecipe()[0].recipe_instruction}
              </Markdown>
